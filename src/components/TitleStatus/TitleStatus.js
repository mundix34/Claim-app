    ...
    render() {
        return (
            <div className="App">
                ...
                <h4 className="upload-heading">In this section you will identify the status of your title, if you have lost or misplaced your title please select "Other"</h4>
